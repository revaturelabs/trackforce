...
public class UserService {
	...
	public UserJSON submitCredentials(LoginJSON login) { 
		...
		Session session = HibernateUtil.getSession(); // throws hibernateException
		// TODO: input a service that makes an associate if possible, if it does then
		// grab its verified field if not
