...
public class Dev3ApiUtil {
	...
	// This information should be changed to be valid login info for the
	// dev3.revature.com
		...
		try {
			...
			if (obj.getInt("statusCode") == 200) {
				...
				for (int i = 0; i < jsonarray.length(); i++) {
					// TfBatch newbatch = new TfBatch(id, location, curriculumName, batchName,
					// startDate, endDate, associates, trainer, coTrainer)
