...
public class SchedulePendingUserCleanup extends TimerTask{
	...
	public void run() {
		...
		/*
		 * iterates through associate list and checks if start date is 
		 * greater than 30 days, and checks if they are not approved.
		 * If they are not approved and greater than 30 days the application
