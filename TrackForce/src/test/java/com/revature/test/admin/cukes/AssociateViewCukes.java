...
public class AssociateViewCukes {
	...
	public void i_login_as_an_Associate() throws Throwable {
		Login.login("TestAssociate55","TestAssociate",ServiceHooks.driver);
		Thread.sleep(1500);
		Login.getSignin(ServiceHooks.driver).click();

		new WebDriverWait(ServiceHooks.driver, 15).until(ExpectedConditions.urlContains("http://34.227.178.103:8090/NGTrackForce/associate-view"));
	}
