...
public class AssociateListTab {
	...
	public static boolean tab(WebDriver d) {
		...
		try {                                                       
			element = WaitToLoad.findDynamicElement(d, By.xpath("/html/body/app/app-root/div/app-navbar/nav/div/ul[1]/li[5]/a "), 10); //html/body/app/div/app-root/div/app-navbar/nav/div/ul[1]/li[4]/a
			element.click();                                     
